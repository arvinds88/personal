...
output_dir <- "/Users/arvind/Documents/Work/Projects/ASSET/Arabic/Y2026v3/"
...
# Build "X{qcode}" versions of the manual drop list for matching
...
for (lvl in levels) {
  ...
  # Flag each drop reason separately for logging
...
# Combined item parameters (post-filtering) for all levels
...
for (i in seq_along(all_ids)) {
  ...
  # Get filtered item parameters for this level
  level_params <- all_item_params[[as.character(lvl)]]

  # Match to items seen by student that survived filtering
